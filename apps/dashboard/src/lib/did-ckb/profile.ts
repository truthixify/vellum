...
export type Services = Record<
  string,
  { type: string; endpoint: string } | { type: string; endpoint: string; [key: string]: unknown }
>;
...
export const DEFAULT_AVATAR_BASE = "https://api.dicebear.com/9.x/pixel-art/png?seed=";
