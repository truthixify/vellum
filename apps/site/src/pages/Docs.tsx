  ...
  return (
    <div className="docs-layout site-content">
      ...
      <article className="docs-article">
        ...
        <p>
          Resolution returns the canonical DID Metadata Cell and its decoded
          document. The current implementation does not infer reputation or
          issuer trust from that document.
        </p>
        <h2 id="install">Install</h2>
        <pre>bun add @ckb-ccc/core @ckb-ccc/did-ckb</pre>
        <h2 id="resolve">Resolve</h2>
        <p>
          Pass an identifier and an explicit network client. Invalid identifiers
          fail before an indexer request is made.
        </p>
        ...
        <ul>
          <li>
            <code>record</code> - a DID cell and decoded v1 document were
            returned.
          </li>
          <li>
            <code>null</code> - no live cell exists for the identifier on that
            network.
          </li>
          <li>
            <code>error</code> - the input is invalid or the RPC/indexer request
            failed.
          </li>
        </ul>
        <h2 id="profile">Read profile fields</h2>
        <p>
          Vellum stores its optional human-readable profile in the{" "}
          <code>services.profile</code> entry with type{" "}
          <code>VellumProfile</code>. Consumers may ignore that service and
          still read a valid did:ckb document.
        </p>
